...
namespace AppInfraCdkV1.PublicThirdOpinion.Stacks
{
    public class PublicThirdOpinionStack : Stack
    {
        ...
        public PublicThirdOpinionStack(Construct scope, string id, DeploymentContext context, IStackProps? props = null)
            : base(scope, id, props)
        {
            // Add tags

            // Create the public website infrastructure
            PublicWebsite = new PublicWebsiteConstruct(this, "PublicWebsite", context);

...
public class TrialMatchDataStack : Stack
{
    ...
    public TrialMatchDataStack(Construct scope,
        string id,
        IStackProps props,
    ...
    private void CreateTrialDocumentStorage(DeploymentContext context)
    {
        ...
        _appBucket = Bucket.FromBucketName(this, "TrialMatchAppBucket", context.Namer.S3Bucket(StoragePurpose.App));

        // Uploads bucket for user uploads
        _uploadsBucket = Bucket.FromBucketName(this, "TrialMatchUploadsBucket", context.Namer.S3Bucket(StoragePurpose.Uploads));

        // Backups bucket for database and application backups
        _backupsBucket = Bucket.FromBucketName(this, "TrialMatchBackupsBucket", context.Namer.S3Bucket(StoragePurpose.Backups));
    }
